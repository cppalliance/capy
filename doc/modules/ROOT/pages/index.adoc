...
* xref:1.cpp20-coroutines/1a.foundations.adoc[{cpp}20 Coroutines Tutorial] — Learn coroutines from the ground up
* xref:3.model/3a.event-driven.adoc[Concurrency Tutorial] — Understand threads, mutexes, and synchronization
