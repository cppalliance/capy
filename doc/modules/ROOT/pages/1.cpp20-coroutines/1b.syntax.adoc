...
* Completed xref:1.cpp20-coroutines/1a.foundations.adoc[Part I: Foundations]
...
The `promise_type` nested structure provides the minimum scaffolding the compiler needs. You will learn what each method does in xref:1.cpp20-coroutines/1c.machinery.adoc[Part III: Coroutine Machinery].
