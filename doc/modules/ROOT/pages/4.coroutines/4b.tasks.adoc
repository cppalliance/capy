...
[source,cpp]
----
include::example$snippets/4b_tasks.cpp[tag=include_task]
----
...
* *xref:4.coroutines/4h.allocators.adoc#_halo_optimization[HALO] support* — Enables Heap Allocation eLision Optimization when possible
...
[source,cpp]
----
include::example$snippets/4b_tasks.cpp[tag=declaring]
----
...
[source,cpp]
----
include::example$snippets/4b_tasks.cpp[tag=returning]
----
...
[source,cpp]
----
include::example$snippets/4b_tasks.cpp[tag=io_task]
----
...
[source,cpp]
----
include::example$snippets/4b_tasks.cpp[tag=run]
----
...
[source,cpp]
----
include::example$snippets/4b_tasks.cpp[tag=awaiting]
----
...
[source,cpp]
----
include::example$snippets/4b_tasks.cpp[tag=lazy]
----
...
[source,cpp]
----
include::example$snippets/4b_tasks.cpp[tag=chain]
----
...
[source,cpp]
----
include::example$snippets/4b_tasks.cpp[tag=final_suspend,indent=0]
----
...
[source,cpp]
----
include::example$snippets/4b_tasks.cpp[tag=move_only]
----
...
[source,cpp]
----
include::example$snippets/4b_tasks.cpp[tag=exceptions]
----
