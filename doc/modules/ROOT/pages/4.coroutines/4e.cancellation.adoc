...
Coroutines have a propagation problem: passing a stop token explicitly to every function clutters your APIs.
...
The stop token mechanism is part of the {cpp} standard library, not Capy:
