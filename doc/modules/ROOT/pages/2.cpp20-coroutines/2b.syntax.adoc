...
funciton `operator co_await` -- if present -- on the result. The result is the awaiter.
It is next use to control the coroutine suspension and resumption via its interface
