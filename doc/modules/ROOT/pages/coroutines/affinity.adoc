...
awaitables or third-party types, Capy provides automatic compatibility through
a trampoline coroutine.
...
The trampoline adds one extra coroutine frame but ensures correct affinity.
Prefer implementing the affine protocol for performance-critical awaitables.
