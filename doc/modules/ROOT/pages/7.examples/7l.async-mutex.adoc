...
* Completed xref:7.examples/7k.strand-serialization.adoc[Strand Serialization]
...
* xref:7.examples/7m.parallel-tasks.adoc[Parallel Tasks] -- Distributing work across a thread pool
