...
* Completed xref:7.examples/7g.parallel-fetch.adoc[Parallel Fetch] (introduces `when_all`)
...
* xref:7.examples/7n.custom-executor.adoc[Custom Executor] -- Building your own execution context
