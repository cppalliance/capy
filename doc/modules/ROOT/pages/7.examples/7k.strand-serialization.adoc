...
* Completed xref:7.examples/7b.producer-consumer.adoc[Producer-Consumer] (introduces `strand`)
...
* xref:7.examples/7l.async-mutex.adoc[Async Mutex] -- FIFO coroutine locking
