...
The _IoAwaitable_ protocol associates a coroutine with three resources: executor, stop token, and allocator. Context propagates **forward** from caller to callee using a well-defined, easy to understand protocol. Most importantly, this protocol _does not require templates_ in the definition of its coroutine machinery.
