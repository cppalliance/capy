...
struct standalone_asio_adapter_context_service 
    : execution_context::service, 
      // shutdown is protected
      ::asio::execution_context
{
    standalone_asio_adapter_context_service(boost::capy::execution_context & ctx) {}
    void shutdown() override {::asio::execution_context::shutdown();}
};
...
template<typename Executor     = capy::any_executor,
         ...
         typename Blocking     = ::asio::execution::blocking_t::possibly_t,
         typename Outstanding  = ::asio::execution::outstanding_work_t::untracked_t>
struct standalone_asio_executor_adapter
{
  template<typename Blocking_, typename Outstanding_>
  standalone_asio_executor_adapter(const standalone_asio_executor_adapter<Executor, Allocator, Blocking_,  Outstanding_> & rhs) 
      noexcept(std::is_nothrow_copy_constructible_v<Executor>)
      : executor_(rhs.executor_), allocator_(rhs.allocator_)
  {  
    if constexpr(Outstanding() == ::asio::execution::outstanding_work.tracked)
      executor_.on_work_started();
  }
  
  template<typename Blocking_, typename Outstanding_>
  standalone_asio_executor_adapter(standalone_asio_executor_adapter<Executor, Allocator, Blocking_,  Outstanding_> && rhs) 
  ...
  standalone_asio_executor_adapter(Executor executor, const Allocator & alloc) 
        noexcept(std::is_nothrow_move_constructible_v<Executor>)
  ...
  standalone_asio_executor_adapter(Executor executor) noexcept(std::is_nothrow_move_constructible_v<Executor>)
  ...
  ~standalone_asio_executor_adapter()
  {
    if constexpr(Outstanding() == ::asio::execution::outstanding_work.tracked)
  ...
  template<typename Blocking_, typename Outstanding_>
  standalone_asio_executor_adapter & operator=(const standalone_asio_executor_adapter<Executor, Allocator, Blocking_,  Outstanding_> & rhs) 
  {
    
    if constexpr (Outstanding_() == ::asio::execution::outstanding_work.tracked)
  ...
  bool operator==(const standalone_asio_executor_adapter & rhs) const noexcept 
  { 
  ...
  constexpr ::asio::execution::blocking_t 
      query(::asio::execution::blocking_t) const noexcept
  {
    return Blocking();
  }

  constexpr standalone_asio_executor_adapter<Executor, Allocator, ::asio::execution::blocking_t::possibly_t, Outstanding>
      require(::asio::execution::blocking_t::possibly_t) const
  {
    return *this;
  }

  constexpr standalone_asio_executor_adapter<Executor, Allocator, ::asio::execution::blocking_t::never_t, Outstanding>
      require(::asio::execution::blocking_t::never_t) const
  {
    return *this;
  }
  
  constexpr standalone_asio_executor_adapter<Executor, Allocator, ::asio::execution::blocking_t::always_t, Outstanding>
  ...
  constexpr standalone_asio_executor_adapter<Executor, Allocator, Blocking, 
      ::asio::execution::outstanding_work_t::tracked_t>
          require(::asio::execution::outstanding_work_t::tracked_t) const
  {
    return *this;
  }
  ...
  constexpr standalone_asio_executor_adapter<Executor, Allocator, Blocking, 
      ::asio::execution::outstanding_work_t::untracked_t>
          require(::asio::execution::outstanding_work_t::untracked_t) const
  {
    return *this;
  }
  ...
  constexpr Allocator query(
      ::asio::execution::allocator_t<OtherAllocator>) const noexcept
  {
    return allocator_;
  }
  template <typename OtherAllocator>
  constexpr standalone_asio_executor_adapter<Executor, OtherAllocator, Blocking, Outstanding>
      require(::asio::execution::allocator_t<OtherAllocator> a) const
  {
    return standalone_asio_executor_adapter<Executor, OtherAllocator, Blocking, Outstanding>(
        executor_, a.value()
      );
  }
  ...
  {
    return executor_.context().template use_service<detail::standalone_asio_adapter_context_service>();
  }

  template <typename Function>
  void execute(Function&& f) const
  {
    constexpr static ::asio::execution::blocking_t b;
 ...
 private:  
  ...
  struct handler_promise_base_
  {
    ...
    void * operator new(std::size_t n, const standalone_asio_executor_adapter & adapter, Func &)
    {
  ...
  friend struct standalone_asio_executor_adapter;
  Executor executor_;
