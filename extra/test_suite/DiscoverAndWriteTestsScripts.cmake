...
function(boost_capy_test_suite_write_tests_file)
    ...
    execute_process(
            ...
            OUTPUT_VARIABLE TEST_SUITE_LIST_TESTS_STDOUT
            ERROR_VARIABLE TEST_SUITE_LIST_TESTS_STDERR
    ...
    if (NOT ${TEST_SUITE_RESULT} EQUAL 0)
        debug_message(FATAL_ERROR
                ...
                "  Output: ${TEST_SUITE_LIST_TESTS_STDOUT}\n"
                "  Stderr: ${TEST_SUITE_LIST_TESTS_STDERR}\n"
        )
    endif ()

    # Extract build date from the binary's stdout
    if (TEST_SUITE_LIST_TESTS_STDOUT MATCHES "Built: ([^\n]+)")
        set(TEST_SUITE_BUILD_DATE "${CMAKE_MATCH_1}")
    endif ()
    debug_message("Build date: ${TEST_SUITE_BUILD_DATE}")

    # Test names are on stderr (written via the test suite log stream)
    # Normalize line endings to \n
    string(REPLACE "\r\n" "\n" TEST_SUITE_LIST_TESTS_STDERR "${TEST_SUITE_LIST_TESTS_STDERR}")
    string(REPLACE "\r" "\n" TEST_SUITE_LIST_TESTS_STDERR "${TEST_SUITE_LIST_TESTS_STDERR}")
    separate_arguments(TEST_SUITE_LIST UNIX_COMMAND "${TEST_SUITE_LIST_TESTS_STDERR}")
    ...
    set(FULL_SCRIPT "${FULL_SCRIPT}message(\"${TEST_SUITE_TEST_TARGET} built: ${TEST_SUITE_BUILD_DATE}\")\n")
